...
{
    Route::get('employee/logout', 'Employees\LogoutEmployeeController')->name('employee.logout');
    Route::get('employee/dashboard', 'Employees\EmployeeFrontController@dashboardEmployee')->name('employee.dashboard');
});
