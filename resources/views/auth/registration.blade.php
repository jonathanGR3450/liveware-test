...
@section('content')
    ...
    <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{ route('register.post') }}" enctype="multipart/form-data"
        method="POST">
        @csrf
        ...
        <div class="space-y-4">
            <label class="flex flex-col">
                ...
                <input
                    ...
                    autofocus="autofocus" name="name" id="name" type="text" value="{{ old('name') }}">
                @error('name')
