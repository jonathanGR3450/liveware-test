...
class EmployeeRepository implements EmployeeRepositoryInterface
{
    public function create(Employee $employee): void
    {
        ...
        $employeeModel->email = $employee->email()->value();
        $employeeModel->password = Hash::make($employee->password()->value());
    ...
    public function savePhoto(Photo $photo, Id $id): void
    {
        ...
        $employeeModel->photos()->save($photo);
    }
    ...
    {
        DB::table('employees')->where('id', $employee->id()->value())->delete();
    }
